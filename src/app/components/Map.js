...
export default function Map({_selected, _setSelected}) {
  ...
  useEffect(() => {       
    markers.forEach((mark) => {
      const marker = new maptilersdk.Marker({ color: mark.color || "#FF0000" })
  ...
  }, [tokyo.lng, tokyo.lat, zoom, _selected, markers]);
